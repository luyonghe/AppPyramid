...
|---|---|---|---|---|---
|1|Log|[Logger](https://github.com/orhanobut/logger)||[CocoaLumberjack `3.3`](https://github.com/CocoaLumberjack/CocoaLumberjack)|[SwiftyBeaver `1.6.0`](https://github.com/SwiftyBeaver/SwiftyBeaver)
|2|网络请求（包含缓存数据的存储）||
